...
# From https://github.com/jkjung-avt/tensorrt_demos/blob/master/utils/visualization.py
"""visualization.py
...
class BBoxVisualization():
    ...
    def draw_bboxes(self, img, boxes, confs, clss, conf_limit):
        """Draw detected bounding boxes on the original image."""
        for bb, cf, cl in zip(boxes, confs, clss):
            if cf < conf_limit:
                continue
            cl = int(cl)
            x_min, y_min, x_max, y_max = bb[1], bb[0], bb[3], bb[2]
